        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="{{ asset('stisla-master/assets/img/logo1.png') }}" alt="logo" width="150" class="shadow-light rounded-circle">
            </div>
              ...
              <div class="card-body">
                <form method="POST" action="{{  route('login-post') }}" class="needs-validation" novalidate="" >
                  ...
                  <div class="form-group">
                    ...
                    <input id="nis" type="text" class="form-control" name="nis" tabindex="1" required autofocus placeholder="Masukan Username...">
                    @error('nis')
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="password" class="form-control" name="password" tabindex="2" required placeholder="Masukan Password...">
                    @error('password')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                  </div>
